...
const Rule= {
     ...
     Pawn: function (props){
          ...
          option to either move two squares forward, or capture a  </Typography>
         <Typography display="block"> &emsp;  piece in a diagonal square.  A pawn cannot jump over a piece whether friendly or opponent’s.  After the initial move, a pawn can only move one square forward, 
           but </Typography>
         <Typography display="block"> &emsp;  can still capture an opponent’s piece in a diagonal.</Typography>
          ...
          <Typography display="block"> &emsp;  vertically and it could have been captured if it had only advanced one square.    One the very next turn,
     ...
     King: function (props){
         ...
         then take the rook's spot.   The rook will  then move in the opposite direction </Typography>
         <Typography display="block"> &emsp;  of the king, jumping over the king, and take the position next to the king.   Keep in mind 
         to complete this, there must not  be a piece inbetween the rook and </Typography>
         <Typography display="block"> &emsp;  the king, whether friendly, or the enemies.  
         Also, if you want to castle, the king must be moved first. Also, if you want to castle, the king must be moved first.</Typography>
         <Typography display="block"> &emsp;  </Typography>
         <Typography display="block"> &emsp; </Typography>
