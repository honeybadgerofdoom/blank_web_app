...
const Rule= {
     ...
     Pawn: function (props){
          ...
          <Typography> &emsp; &emsp; &emsp; The pawn is the only piece that can not move backwards. When a pawn initially moves, it has the  
          option to either move two squares forward, or capture a piece in a diagonal square.  A pawn cannot jump over a  </Typography>
         <Typography display="block"> &emsp;  piece whether friendly or opponent’s.  After the initial move, a pawn can only move one square forward, 
         but can still capture an opponent’s piece in a diagonal.</Typography>
          ...
          promoted to another piece of the player’s choosing. This includes, king, queen, knight, bishop, or rook. The piece will immediately, </Typography> 

          <Typography display="block"> &emsp;  before the end of turn, be replaced to the new piece.  There is no limit to which piece you can promote to, 
          even if it’s always the same one. </Typography>
          ...
          opponent’s pawn, when it moves two squares vertically and it could have been captured if it had only advanced one square.    One the very next turn,
     ...
     King: function (props){
         ...
         then take the rook's spot.   The rook will </Typography>
         <Typography display="block"> &emsp;  then move in the opposite direction of the king, jumping over the king, and take the position next to the king.   Keep in mind to complete this, there must not  </Typography>
         <Typography display="block"> &emsp; be a piece inbetween the rook and the king, whether friendly, or the enemies.  </Typography>
         <Typography display="block"> &emsp;  Also, if you want to castle, the king must be moved first.</Typography>
         <Typography display="block"> &emsp; </Typography>
