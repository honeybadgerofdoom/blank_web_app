...
- Test that a user can view a list of all matches they are a part of.
...
#### Acceptance Criteria
- Test if a user can send invitations to other users.
...
- Test if the user can see another user’s statistics update on their profile.
...
- Test that when a user quits the game, it is added to their profile, for both players.
